    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between gap-12 mb-24">
        <div className="flex-1 space-y-6">
          ...
          <h2 className="text-2xl md:text-3xl text-gray-500 dark:text-gray-400 flex items-center gap-2">
            <FiCloud aria-hidden="true" className="text-primary-500" />
            Cloud & DevOps Engineer
          </h2>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl">
            I design, build, and automate scalable cloud infrastructure.
            Passionate about Kubernetes, Infrastructure as Code, and building
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Button
              ...
              as={Link}
              color="secondary"
              endContent={<FiDownload aria-hidden="true" size={16} />}
              href="/cv.pdf"
              target="_blank"
              variant="flat"
            >
      ...
      <section className="mb-24" id="skills">
        <h2 className="text-3xl font-bold mb-8 text-center flex items-center justify-center gap-2">
          ...
          Core <span className="text-primary-500">Competencies</span>
        </h2>
        <Skills />
      </section>
      ...
      <section className="mb-24" id="projects">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-3xl font-bold flex items-center gap-2">
            <FiServer aria-hidden="true" className="text-primary-500" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              <div className="p-12 flex flex-col justify-center">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold">GitOps k3s Cluster</h3>
                  <Chip color="success">Active</Chip>
                </div>
                <h4 className="text-xl text-gray-600 dark:text-gray-300 mb-4">
                  Automated Kubernetes Environment
                </h4>
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  A fully declarative Kubernetes homelab built on k3s. Employs a
                  GitOps methodology utilizing ArgoCD to automatically
                  synchronize cluster state with Git repositories, including
                  deployments pulling from GitHub Container Registry.
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  {[
                    ...
                    <Chip key={index} startContent={tech.icon} variant="flat">
                      {tech.name}
                    </Chip>
                  ))}
                </div>
        ...
        {/* Project 4 - Noti.u Chrome Extension */}
        <div className="mb-32">
          <div className="bg-gray-50 dark:bg-gray-900 rounded-3xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              <div className="p-12 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="bg-gray-100 dark:bg-gray-800 flex items-center justify-center p-8">
                <Image
                  ...
                  src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
                />
              </div>
            </div>
          </div>
      ...
      <section className="mb-12" id="contact">
        <div className="bg-primary-50 dark:bg-primary-900/20 rounded-2xl p-8 md:p-12">
          ...
          <p className="text-lg mb-6 max-w-2xl">
            Interested in optimizing your cloud infrastructure or building
            robust delivery pipelines? Feel free to reach out.
          </p>
