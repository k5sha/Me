...
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
  ...
  <section className="flex flex-col md:flex-row items-center justify-between gap-12 mb-24">
    <div className="flex-1 space-y-6">
      <Chip color="primary" startContent={ <FiUserCheck aria-hidden="true" className="text-lg ps-1" />
      }
      variant="flat"
      >
      Available for work
      ...
      <div className="flex flex-wrap gap-3">
        <Button aria-label="Contact me via email" as={Link} color="primary" endContent={<FiMail aria-hidden="true"
          size={18} />}
        href="#contact"
        variant="solid"
        >
        ...
        <Button aria-label="View projects section" as={Link} endContent={<FiExternalLink aria-hidden="true"
          size={16} />}
        href="#projects"
        variant="bordered"
        >
    ...
    <Avatar isBordered alt="Yurii Yevtushenko's profile photo" className="w-48 h-48 md:w-64 md:h-64 text-large"
      color="primary" src="https://avatars.githubusercontent.com/u/65705493?v=4" />
  </section>
      ...
      <div className="bg-gray-50 dark:bg-gray-900 rounded-3xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          <div className="p-12 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-3">
              <Button aria-label="View WebRoom live demo" as={Link} color="primary" endContent={<FiVideo
              ...
              <Button aria-label="Visit WebRoom website" as={Link} endContent={<FiExternalLink aria-hidden="true"
                size={16} />}
          ...
          <div className="bg-gray-100 dark:bg-gray-800 flex items-center justify-center p-8">
            <Image alt="WebRoom interface screenshot"
      ...
      <div className="bg-gray-50 dark:bg-gray-900 rounded-3xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          <div className="p-12 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-3">
              <Button aria-label="View ZipZip live demo" as={Link} color="primary" endContent={<FiVideo
                aria-hidden="true" size={16} />}
              ...
              <Button aria-label="Visit ZipZip website" as={Link} endContent={<FiExternalLink aria-hidden="true"
                size={16} />}
              href="https://zipzip.online/"
              variant="bordered"
              >
          ...
          <div className="bg-gray-100 dark:bg-gray-800 flex items-center justify-center p-8">
            <Image alt="ZipZip online archiver screenshot"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          <div className="p-12 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-2 mb-8">
              {[
              { icon:
              <SiGo className="text-blue-500" />, name: "Go" },
              {
              icon:
              ...
              { icon:
              <FaAws className="text-amber-600" />, name: "AWS" },
              ].map((tech, index) => (
              <Chip key={index} aria-label={`Built with ${tech.name}`} startContent={tech.icon} variant="flat">
                {tech.name}
              </Chip>
              ))}
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <Button aria-label="View Ticketo project" as={Link} color="primary" endContent={<FiExternalLink
                aria-hidden="true" size={16} />}
              ...
              <Button aria-label="View Ticketo source code" as={Link} endContent={<FiGithub aria-hidden="true"
                size={16} />}
              href="#"
              variant="bordered"
              >
          ...
          <div className="bg-gray-100 dark:bg-gray-800 flex items-center justify-center p-8">
            <Image alt="Ticketo interface screenshot"
              className="rounded-xl shadow-2xl border border-gray-300 dark:border-gray-700"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          <div className="p-12 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-2 mb-8">
              ...
              <Chip key={index} aria-label={`Technology: ${tech}`} variant="flat">
                {tech}
              </Chip>
              ))}
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <Button aria-label="View Noti.u on Chrome Web Store" as={Link} color="primary" endContent={<FiExternalLink
                aria-hidden="true" size={16} />}
              ...
              <Button aria-label="View Noti.u source code" as={Link} endContent={<FiGithub aria-hidden="true"
                size={16} />}
            ...
            <div className="relative w-full max-w-md">
              ...
              <div className="bg-gray-200 dark:bg-gray-700 rounded-t-lg p-2 flex items-center">
                <div className="flex space-x-2">
                  ...
                  <div key={color} aria-hidden="true" className={`w-3 h-3 rounded-full bg-${color}-500`} />
                  ))}
                </div>
              ...
              {/* Browser content */}
              <div
                className="bg-white dark:bg-gray-600 p-6 rounded-b-lg border border-t-0 border-gray-300 dark:border-gray-700">
                <p className="mb-4">
    ...
    <div className="mb-32">
      <div className="bg-gray-50 dark:bg-gray-900 rounded-3xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          <div className="p-12 flex flex-col justify-center">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-lg bg-purple-500 flex items-center justify-center">
                <SiNextdotjs aria-hidden="true" className="text-white text-xl" />
              </div>
            ...
            <div className="flex flex-wrap gap-3">
              <Button aria-label="View live portfolio" as={Link} color="primary" endContent={<FiExternalLink
                aria-hidden="true" size={16} />}
              href="/"
              variant="solid"
              >
              ...
              <Button aria-label="View portfolio source code" as={Link} endContent={<FiGithub aria-hidden="true"
                size={16} />}
          ...
          <div className="bg-gray-100 dark:bg-gray-800 flex items-center justify-center p-8">
            <Image alt="Portfolio website screenshot"
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <div className="flex items-center gap-4">
          <Tooltip content="GitHub profile">
            <Link isExternal aria-label="GitHub profile (opens in new tab)" href={siteConfig.links.github}>
            <FiGithub aria-hidden="true" className="text-gray-700 dark:text-gray-300 hover:text-primary-500 text-2xl" />
            </Link>
          </Tooltip>

          <Tooltip content="LinkedIn profile">
            <Link isExternal aria-label="LinkedIn profile (opens in new tab)" href={siteConfig.links.linkedin}>
          ...
          <Tooltip content="Medium articles">
            <Link isExternal aria-label="Medium articles (opens in new tab)" href={siteConfig.links.medium}>
            <SiMedium aria-hidden="true" className="text-gray-700 dark:text-gray-300 hover:text-primary-500 text-2xl" />
            </Link>
          </Tooltip>
        </div>
      </div>
